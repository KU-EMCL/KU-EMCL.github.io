...
window.EMCL_SEED_POSTS = [
  { id: "p10", category: "notice",  pinned: true,
    ...
    content: "에너지물질순환연구실(EMCL)에서 2025학년도 신입 대학원생(석사·박사) 및 학부연구생을 모집합니다.\n\n· 모집 분야: 열에너지 저장 소재, 플러스에너지빌딩, 에너지 하베스팅, 나노복합 소재\n· 지원 자격: 기계공학·화학공학·재료공학 등 관련 전공\n· 문의: emcl@korea.ac.kr\n\n연구에 열정이 있는 분들의 많은 지원 바랍니다.",
    images: [] },
  { id: "p9", category: "seminar", pinned: false,
    title: "국제 학술대회 논문 발표 안내 (ICEB 2024)",
    author: "관리자", date: "2024.10.15",
    content: "International Conference on Energy and Buildings 2024 (ICEB 2024)에서 본 연구실의 PCM 기반 열에너지 저장 연구 결과를 구두 발표합니다.\n\n· 일시: 2024년 11월\n· 발표 주제: PCM-based thermal energy storage for HVAC applications",
    images: [] },
  { id: "p8", category: "news", pinned: false,
    title: "고려대 플러스에너지빌딩 연구센터 성과 발표회",
    author: "관리자", date: "2024.09.20",
    content: "한국연구재단 지원 플러스에너지빌딩(PEB) 혁신기술 연구센터의 연간 성과 발표회가 개최되었습니다. 본 연구실은 통합 열에너지 저장 시스템 부문 성과를 공유하였습니다.",
    images: [] },
  ...
  { id: "p3", category: "news", pinned: false,
    ...
    content: "나노복합 열전달 소재 설계 및 합성 연구 과제(한국연구재단)를 신규 수주하였습니다. 기간: 2024.03 ~ 2027.02",
    images: [] },
...
window.EMCL_SEED_GALLERY = [
  ...
  { id: "g2", title: "PCM 실험",   date: "2024", color: "linear-gradient(135deg,#1F5048,#2C6E63)", src: "" },
  { id: "g3", title: "ICEB 2024 발표", date: "2024", color: "linear-gradient(135deg,#7a5a16,#B0832B)", src: "" },
